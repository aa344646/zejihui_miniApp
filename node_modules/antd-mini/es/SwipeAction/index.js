...
var setStyleObj1 = function (buttons, inertiaWidth) {
    ...
    return [
        ...
        { marginLeft: "".concat(-(((_b = buttons[0]) === null || _b === void 0 ? void 0 : _b.width) + ((_c = buttons[1]) === null || _c === void 0 ? void 0 : _c.width) + 1 + (inertiaWidth || 0) * 0.6666) / 2, "px") }
    ];
};
var setStyleObj2 = function (buttons, inertiaWidth) {
    ...
    if (length === 2) {
        return [{ marginRight: 0 }, { marginRight: "-".concat((((_a = buttons[0]) === null || _a === void 0 ? void 0 : _a.width) + (inertiaWidth || 0) * 0.5) / 2, "px") }];
    }
    if (length === 3) {
        return [{ marginRight: 0 }, { marginRight: "-".concat((((_b = buttons[0]) === null || _b === void 0 ? void 0 : _b.width) + ((inertiaWidth || 0) * 0.3333)) / 2, "px") }, { marginRight: "-".concat(((((_c = buttons[0]) === null || _c === void 0 ? void 0 : _c.width) + ((_d = buttons[1]) === null || _d === void 0 ? void 0 : _d.width) + ((inertiaWidth || 0) * 0.6666))) / 2, "px") }];
    }
...
Component({
    ...
    methods: {
        ...
        onSetCheck: function (isRight) {
            ...
            var styArr = isRight ? setStyleObj1(_rightButtons, inertiaWidth) : setStyleObj2(_leftButtons, inertiaWidth);
            var sty = styArr[idx];
        ...
        onItemTap: function (e) {
            ...
            if (confirmType === 'tap' || confirmType === 'move') {
                var styArr = swipeLeft ? setStyleObj1(_rightButtons) : setStyleObj2(_leftButtons);
                var sty = styArr[idx];
                this.setData({ myStyle: sty });
